    ...
    <section className="py-24 bg-gradient-to-b from-amber-50 to-orange-50 relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center bg-amber-200 text-amber-800 px-4 py-2 rounded-full mb-4 mx-auto">
          ...
          <Link 
            to="/retro" 
            className="group inline-flex items-center mt-6 text-amber-700 font-semibold hover:text-amber-800 transition-colors bg-amber-100 px-6 py-3 rounded-full mx-auto"
          >
        ...
        <div className="mt-16 relative rounded-3xl overflow-hidden shadow-2xl">
          ...
          <div className="relative px-8 py-16 md:p-16 text-center md:text-center">
            <div className="max-w-3xl mx-auto">
              <div className="inline-flex items-center bg-amber-500/20 backdrop-blur-sm text-amber-300 px-4 py-2 rounded-full mb-6 border border-amber-400/30 mx-auto">
                <Trophy className="w-4 h-4 mr-2" />
